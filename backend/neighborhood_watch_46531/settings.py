"""
Django settings for neighborhood_watch_46531 project.
...
ROOT_URLCONF = 'neighborhood_watch_46531.urls'
...
WSGI_APPLICATION = 'neighborhood_watch_46531.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "neighborhood_watch_46531 API",
    "DESCRIPTION": "API documentation for neighborhood_watch_46531 App",
    "VERSION": "v1",
}
